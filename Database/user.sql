...
GRANT SELECT (Surname, AccountID, City, Email, StreetNumber, Infix, PostalCode, Street, Gender, Firstname), INSERT (Surname, AccountID, City, Email, StreetNumber, Infix, PostalCode, Street, Gender, Firstname) ON `nerdygadgets`.`account` TO 'klant'@'%';
