-- Admin
CREATE USER
IF NOT EXISTS 'user'@'localhost' IDENTIFIED BY 'ZeFdQTBFxcrFmDGe';
GRANT ALL PRIVILEGES ON *.* TO 'administrator'@'%' IDENTIFIED BY PASSWORD '*2E63A4048F4073C9208797D301D53E4ADC4D0083'
WITH
GRANT OPTION;
...
-- Pi
CREATE USER
IF NOT EXISTS 'user'@'localhost' IDENTIFIED BY 'temperatuursensor';
